...
const descriptionString = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. There ${unfundedGamesCount === 1 ? "is" : "are"} ${unfundedGamesCount} game${unfundedGamesCount === 1 ? "" : "s"} currently unfunded.`;
